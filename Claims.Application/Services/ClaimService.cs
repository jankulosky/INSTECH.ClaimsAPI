...
public class ClaimService : IClaimService
{
    ...
    public async Task<IReadOnlyCollection<ClaimModel>> GetAllAsync(CancellationToken cancellationToken)
    {
        var claims = await _claimRepository.GetAllAsync(cancellationToken);
        return claims.Select(x => x.ToModel()).ToArray();
    }

    public async Task<ClaimModel> GetByIdAsync(string id, CancellationToken cancellationToken)
    {
    ...
    public async Task<ClaimModel> CreateAsync(CreateClaimRequest request, CancellationToken cancellationToken)
    {
        ...
        _auditRepository.SaveClaimAudit(claim.Id, AuditConstants.HttpPost);
    ...
    public async Task DeleteAsync(string id, CancellationToken cancellationToken)
    {
        ...
        _auditRepository.SaveClaimAudit(id, AuditConstants.HttpDelete);
    }
